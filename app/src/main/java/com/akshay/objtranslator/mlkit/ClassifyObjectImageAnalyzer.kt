...
import com.akshay.objtranslator.mlkit.ar.ArObject
import com.akshay.objtranslator.mlkit.ar.ArObjectTracker
...
class ClassifyObjectImageAnalyzer : ViewModel(),
    ThreadedImageAnalyzer {
    ...
    private val handlerThread = HandlerThread("ClassifyObjectImageAnalyzer").apply { start() }
                ...
                /*it.result!!.forEach {
                    ...
                    uiHandler.post {
                        arObjectTracker.processObject(
                            if (it != null) {
                                ArObject(
                                    trackingId = it.trackingId ?: -1,
                                    boundingBox = it.boundingBox.toRectF(),
